...
return [
    ...
    | possèdent plusieurs versions, comme les règles de taille. N'hésitez pas
    ...
    */
    ...
    'ascii' => 'Le champ :attribute ne doit contenir que des caractères et des symboles alphanumériques sur un octet.',
    ...
    |--------------------------------------------------------------------------
    |
    | Vous pouvez ici spécifier des messages de validation personnalisés pour
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langue suivantes sont utilisées pour remplacer le
    | terme générique de nos attributs par quelque chose de plus lisible
    | comme « adresse e-mail » au lieu de « email ». Cela nous aide à
    | rendre nos messages un peu plus expressifs.
    |
    */
